...
public class orangeHRM {
	...
	public void fillJobForm() throws Throwable{
		...
		driver.findElement(By.id("addJobVacancy_hiringManager")).sendKeys("Sach Tripathy");
	...
	public void candidateForm() throws Throwable{
		Thread.sleep(6000);
		driver.findElement(By.id("addCandidate_firstName")).sendKeys("Kanun");
		driver.findElement(By.id("addCandidate_lastName")).sendKeys("Nanda");
		driver.findElement(By.id("addCandidate_email")).sendKeys("test96@gmail.com");
		driver.findElement(By.id("addCandidate_contactNo")).sendKeys("800009899");
		...
		public void uploadResume() throws Throwable{
			...
			uploadElement.sendKeys("C:\\Users\\SACHISMATRIPATHY\\Documents\\Automation_Workspace\\Cucumber_Live_Projects\\src\\test\\resources\\Resume.pdf");
		}
		@And("^Click Save$")
		...
		public void validateCandidature() throws Throwable{
			...
			driver.findElement(By.id("candidateSearch_candidateName")).sendKeys("Kanun Nanda");
			driver.findElement(By.id("btnSrch")).click();
			Thread.sleep(5000);
			...
			String JobTitle1 = driver.findElement(By.linkText("Kanun Nanda")).getText();
	    	Assert.assertEquals(JobTitle1, "Kanun Nanda"); 
		}
