...
public class AlchemyJobs {
		...
		public void createNewUser() throws InterruptedException
		{
	    	...
	    	driver.findElement(By.id("user_login")).sendKeys("QASDET123");
	    	driver.findElement(By.id("email")).sendKeys("sach2021@email.com");
	    	Thread.sleep(1000);
		 ...
		 @And("^Validate that the user has been created$")
		    public void validateUserCreation() throws Throwable {
		    	...
		    	driver.findElement(By.id("user-search-input")).sendKeys("QASDET123");
		    	driver.findElement(By.id("search-submit")).click();
		    	WebElement userName = driver.findElement(By.cssSelector(".username > strong:nth-child(2) > a:nth-child(1)"));
		    	Assert.assertEquals(userName.getText(), "QASDET123");
		    } 
