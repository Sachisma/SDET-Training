...
Scenario Outline: Post a job using details passed from the Feature file
    ...
    When User provides the information "testSDETQA6@gmail.com" , "SDET Tester1" , "Bengaluru" , "Need a tester with knowledge of JAVA, Python, Selenium, TestNG, ReportNG, Cucumber, Jira, Zypher and Manual Testing" , "testqa12@gmail.com" and "IBM India Pvt Ltd"  
    Then Click submit
    And Go to the Jobs page
    And Confirm job listing is shown on page with Job Name and Location as "SDET Tester1" and "Bengaluru"
    And Close the Browser
...
|testqasdet6@gmail.com|SDET Testers|Bangalore|Need a tester with knowledge of JAVA, Python, Selenium, TestNG, ReportNG, Cucumber, Jira, Zypher and Manual Testing|testqa1@gmail.com|IBM India Pvt Ltd|
