...
Scenario Outline: Open the Leads page and add multiple lead accounts using values passed from Feature file
    ...
    When Fill in the necessary details to create lead accounts using the values passed from the Feature file as "Ms." and "Sachismita" and "Tripathy" and "sachisma8412@gmail.com"
    Then Click Save to finish
    And Navigate to the View Leads page to see results as "MS." and "SACHISMITA" and "TRIPATHY"
